...
const KIND_LABEL: Record<string, string> = { verdicts: 'Community verdicts', leaks: 'Upvoted leaks', sanctions: 'Sanctions listings (OpenSanctions)', promises: 'Broken promises (published with evidence)' }
